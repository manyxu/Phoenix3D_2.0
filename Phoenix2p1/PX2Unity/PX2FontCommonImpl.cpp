...
{
	mFontTex = new0 Texture2D(Texture::TF_A8R8G8B8, mTexWidth, mTexHeight, 1);
	...
	Rectf &rectUV)
{
	...
	fX2 = fX1 + charWidth + 0.5f;
	fX1 /= mTexWidth;
	fX2 /= mTexWidth;	

	fY1 = (float)(mTexHeight - (texY+1)*mFontHeight);
