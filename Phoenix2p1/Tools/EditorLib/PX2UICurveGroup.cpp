/*
*
* ÎÄ¼þÃû³Æ	£º	PX2CurveGroupUI.cpp
*
*/
...
mCurveGroup(group)
{
	...
	Sizef sizeBackground(120.0f, 36.0f);
	...
	mBackground->SetTexCornorSize(Sizef(2.0f, 2.0f));
	mBackground->SetTexture("ToolRes/images/smallPic1.png");
	...
	float boxZPos = 4.0f;
	mBox0 = new0 UIPicBox();
	mBox0->SetTexture("ToolRes/images/smallPic.png");
	...
	{
		mBox1 = new0 UIPicBox();
		mBox1->SetTexture("ToolRes/images/smallPic.png");
	...
	{
		mBox2 = new0 UIPicBox();
		mBox2->SetTexture("ToolRes/images/smallPic.png");
	...
	{
		mBox3 = new0 UIPicBox();
		mBox3->SetTexture("ToolRes/images/smallPic.png");
	...
	{
		mBox4 = new0 UIPicBox();
		mBox4->SetTexture("ToolRes/images/smallPic.png");
	...
	{
		mBox5 = new0 UIPicBox();
		mBox5->SetTexture("ToolRes/images/smallPic.png");
	...
	mBox = new0 UIPicBox();
	mBox->SetTexture("ToolRes/images/smallPic.png");
	...
	mStaticText = new0 UIStaticText();
	mStaticText->SetFont("ToolRes/fonts/arial.ttf", 14, 14);
	mStaticText->LocalTransform.SetTranslate(APoint(boxXStart, 0.0f,
		boxZPos+boxWidth+4.0f));
	AttachChild(mStaticText);
	if (mCurveGroup)
