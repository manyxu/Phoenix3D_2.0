/*
*
* ÎÄ¼þÃû³Æ	£º	PX2CurveGroupUI.hpp
*
*/
...
namespace PX2
{
	...
	public:
		UICurveGroup (PX2Editor::CurveGroup *group);
		...
		PX2Editor::CurveGroup *GetCurveGroup () { return mCurveGroup; }
	...
	protected:
		...
		Sizef mSize;
		PX2Editor::CurveGroupPtr mCurveGroup;
