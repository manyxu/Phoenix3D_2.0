/*
*
* ÎÄ¼þÃû³Æ	£º	PX2Keyboard.hpp
*
*/

#ifndef PX2KEYBOARD_HPP
#define PX2KEYBOARD_HPP
...
namespace PX2
{
	...
	{
	public:
		KeyEvent (InputObject* obj, KeyCode kc, unsigned int txt);
		virtual ~KeyEvent();
	...
	public:
		...
		void SetEventCallback (KeyListener *keyListener);
		...
		void SetTextTranslation (TextTranslationMode mode);
	...
	protected:
		Keyboard (const std::string &vendor, bool buffered, int devID,
