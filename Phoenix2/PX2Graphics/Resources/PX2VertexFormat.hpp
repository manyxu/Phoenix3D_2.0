...
namespace PX2
{
	...
	/// 顶点格式类
	class PX2_GRAPHICS_ENTRY VertexFormat : public Object
	{
		PX2_DECLARE_RTTI;
		PX2_DECLARE_NAMES;
	...
	public:
		...
		/// 每个通道的数据格式
		enum PX2_GRAPHICS_ENTRY AttributeType
		{
			AT_NONE,
			AT_FLOAT1,
			AT_FLOAT2,
		...
		/// 顶点格式每个通道语义
		enum PX2_GRAPHICS_ENTRY AttributeUsage
		{
			AU_NONE,
			AU_POSITION,      // attr 0
			AU_NORMAL,        // attr 2
	...
	protected:
		/// 顶点格式通道信息
		class PX2_GRAPHICS_ENTRY Element
		{
		public:
