...
namespace PX2
{
	...
	class PX2_GRAPHICS_ENTRY AlphaProperty : public Object
	{
		PX2_DECLARE_RTTI;
		PX2_DECLARE_NAMES;
	...
	public:
		...
		enum PX2_GRAPHICS_ENTRY SrcBlendMode
		{
			SBM_ZERO,
			SBM_ONE,
			SBM_DST_COLOR,
		...
		enum PX2_GRAPHICS_ENTRY DstBlendMode
		{
			DBM_ZERO,
			DBM_ONE,
			DBM_SRC_COLOR,
		...
		enum PX2_GRAPHICS_ENTRY CompareMode
		{
			CM_NEVER,
			CM_LESS,
			CM_EQUAL,
