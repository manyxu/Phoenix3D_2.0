...
#define ID_RESTREE wxID_HIGHEST + 2000
...
void ResTree::OnItemActivated(wxTreeEvent& event)
{
	...
	{
		PX2::Soundable *soundable = new0 Soundable();
		soundable->SetSoundFile(resPath);
		soundable->SetResourcePath(resPath);
		EditSystem::GetSingleton().SetSelectedResource(soundable);
