...
BEGIN_EVENT_TABLE(DlgNewTerrain, wxDialog)
	EVT_BUTTON(wxID_ANY, DlgNewTerrain::OnButton)
END_EVENT_TABLE()

DlgNewTerrain::DlgNewTerrain (wxWindow *parent)
{
	const bool success = 
		wxXmlResource::Get()->LoadDialog(this,
		parent, TEXT("NewTerrain") );
...
//----------------------------------------------------------------------------
void DlgNewTerrain::OnButton (wxCommandEvent& event)
{
