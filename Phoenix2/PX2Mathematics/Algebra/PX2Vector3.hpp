...
namespace PX2
{
	...
	public:
		...
		*/
		...
		// 常用值
		PX2_MATHEMATICS_ENTRY static const Vector3 ZERO;    // (0,0,0)
		PX2_MATHEMATICS_ENTRY static const Vector3 UNIT_X;  // (1,0,0)
		PX2_MATHEMATICS_ENTRY static const Vector3 UNIT_Y;  // (0,1,0)
		PX2_MATHEMATICS_ENTRY static const Vector3 UNIT_Z;  // (0,0,1)
		PX2_MATHEMATICS_ENTRY static const Vector3 ONE;     // (1,1,1)
