...
namespace PX2
{
	...
	public:
		...
		// Special vectors.
		PX2_MATHEMATICS_ENTRY static const Vector2 ZERO;    // (0,0)
		PX2_MATHEMATICS_ENTRY static const Vector2 UNIT_X;  // (1,0)
		PX2_MATHEMATICS_ENTRY static const Vector2 UNIT_Y;  // (0,1)
		PX2_MATHEMATICS_ENTRY static const Vector2 ONE;     // (1,1)
