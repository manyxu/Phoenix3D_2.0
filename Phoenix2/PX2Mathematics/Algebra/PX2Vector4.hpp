...
namespace PX2
{
	...
	public:
		...
		// 特定值
		PX2_MATHEMATICS_ENTRY static const Vector4 ZERO;
		PX2_MATHEMATICS_ENTRY static const Vector4 UNIT_X;  //< (1,0,0,0)
		PX2_MATHEMATICS_ENTRY static const Vector4 UNIT_Y;  //< (0,1,0,0)
		PX2_MATHEMATICS_ENTRY static const Vector4 UNIT_Z;  //< (0,0,1,0)
		PX2_MATHEMATICS_ENTRY static const Vector4 UNIT_W;  //< (0,0,0,1)
		PX2_MATHEMATICS_ENTRY static const Vector4 ONE;     //< (1,1,1,1)
