...
#ifndef PX2COREPREREQUISITES_HPP
#define PX2COREPREREQUISITES_HPP
...
// Begin Microsoft Windows DLL
    ...
    #define PX2_CORE_ENTRY __declspec(dllexport)
#elif defined(PX2_CORE_DLL_IMPORT)
    #define PX2_CORE_ENTRY __declspec(dllimport)
#else
    #define PX2_CORE_ENTRY
#endif
